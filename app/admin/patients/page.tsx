...
export default function PatientManagementPage() {
    ...
    const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        // 4. TS จะรู้ทันทีว่า patient มี property อะไรบ้าง ทําให้เราเรียกใช้ .patient_name ได้อย่างปลอดภัย
    ...
    // 5. เปลี่ยน Type ของ item จาก any เปน PatientRecord
    const handleEdit = (item: PatientRecord) => {
        alert(`ระบบจะพาไปหน้าแก้ไขข้อมูลของ: ${item.patient_name}`)
